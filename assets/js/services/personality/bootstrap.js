/**
 * TOPCARE AI PLATFORM V2 — PERSONALITY DOMAIN BOOTSTRAP
 * Path: assets/js/services/personality/bootstrap.js
...
export const PersonalityDomainBootstrap = (() => {
    ...
    return Object.freeze({
        initialize() {
            if (_initialized) {
                return { success: true, domainId: 'personality', alreadyInitialized: true, ..._metrics };
            }
            ...
            try {
                ...
                _initialized = true;
                Core.Logger.info(`[PersonalityDomain] Bootstrapped successfully (${_metrics.registeredManifests} manifests).`);
                ...
                Core.Logger.error('[PersonalityDomain] Bootstrap failed:', error);
                return {
                    success: false,
                    domainId: 'personality',
                    error: error.message,
...
export default PersonalityDomainBootstrap;