/**
 * TOPCARE AI PLATFORM V2 — CAREER DOMAIN BOOTSTRAP
 * Path: assets/js/services/career/bootstrap.js
...
export const CareerDomainBootstrap = (() => {
    ...
    return Object.freeze({
        initialize() {
            if (_initialized) {
                return { success: true, domainId: 'career', alreadyInitialized: true, ..._metrics };
            }
            ...
            try {
                ...
                _initialized = true;
                Core.Logger.info(`[CareerDomain] Bootstrapped successfully (${_metrics.registeredManifests} manifests).`);
                ...
                Core.Logger.error('[CareerDomain] Bootstrap failed:', error);
                return {
                    success: false,
                    domainId: 'career',
                    error: error.message,
...
export default CareerDomainBootstrap;