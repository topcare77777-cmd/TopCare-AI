/**
 * TOPCARE AI PLATFORM V2 — PLANNING DOMAIN BOOTSTRAP
 * Path: assets/js/services/planning/bootstrap.js
...
export const PlanningDomainBootstrap = (() => {
    ...
    return Object.freeze({
        initialize() {
            if (_initialized) {
                return { success: true, domainId: 'planning', alreadyInitialized: true, ..._metrics };
            }
            ...
            try {
                ...
                _initialized = true;
                Core.Logger.info(`[PlanningDomain] Bootstrapped successfully (${_metrics.registeredManifests} manifests).`);
                ...
                Core.Logger.error('[PlanningDomain] Bootstrap failed:', error);
                return {
                    success: false,
                    domainId: 'planning',
                    error: error.message,
...
export default PlanningDomainBootstrap;