/**
 * TOPCARE AI PLATFORM V2 — WELLNESS DOMAIN BOOTSTRAP
 * Path: assets/js/services/wellness/bootstrap.js
...
export const WellnessDomainBootstrap = (() => {
    ...
    return Object.freeze({
        initialize() {
            if (_initialized) {
                return { success: true, domainId: 'wellness', alreadyInitialized: true, ..._metrics };
            }
            ...
            try {
                ...
                _initialized = true;
                Core.Logger.info(`[WellnessDomain] Bootstrapped successfully (${_metrics.registeredManifests} manifests).`);
                ...
                Core.Logger.error('[WellnessDomain] Bootstrap failed:', error);
                return {
                    success: false,
                    domainId: 'wellness',
                    error: error.message,
...
export default WellnessDomainBootstrap;