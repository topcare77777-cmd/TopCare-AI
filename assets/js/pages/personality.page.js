...
/**
 * @file personality.page.js
 * @description Personality landing page controller with routing integration for Quiz V2.
 * @module Pages/Personality
 */
...
export class PersonalityPage {
    constructor() {
        this.containerId = 'personality-test';
    }
...
export default new PersonalityPage();